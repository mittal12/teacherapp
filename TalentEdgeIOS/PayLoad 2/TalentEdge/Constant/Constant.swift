...
let kGrayColor = UIColor.init(hexString: "707070")//UIColor.lightGray
...
let API_GETBATCH_STUDENTS_LISTING = "getBatchStudentsListing"
let API_PROFILE_DETAILS = "profileDetails"
