...
class TMyCourseDetailViewController: UIViewController {
    ...
    //
        ...
        var moduleArray = ["DASHBOARD","MODULES", "LIVE CLASSES","ATTENDANCE","ASSIGNMENTS","ASSESSMENTS","DISCUSSIONS","LEARNERS","TESTIMONIALS"]
        var moduleControllerArray = ["TDetailDashBoardViewController","ExpandableModuleViewController","TLiveClassesViewController","TAttendenceViewController","TAssignmentViewController","TAssessmentViewController","DiscussionViewController","LearnerVireController","TestimonialViewController"]
