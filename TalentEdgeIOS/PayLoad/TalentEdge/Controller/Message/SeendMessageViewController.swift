//
//  SeendMessageViewController.swift
//  TalentEdge
//
//
...
class SeendMessageViewController: UIViewController, UITextViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
//            queryParamHash.setValue(subject, forKey: "subject")
//            queryParamHash.setValue(desc, forKey: "message")
//            queryParamHash.setValue(DataUtils.jsonStringWithJSONObject(arr)!, forKey: "to_id")
//            queryParamHash.setValue(selectedBatch.id.integerValue, forKey: "batch_id")
//            queryParamHash.setValue(raiseADoubt ? 1 : 0, forKey: "is_doubt")
//            queryParamHash.setValue("image/jpg", forKey: "mime")
//            queryParamHash.setValue(selectedImage, forKey: "file1")
//            queryParamHash.setValue("[file1]", forKey: "file")
//            ServerCommunication.singleton.requestWithPostToSendImages(API_SEND_MESSAGE, headerDict: headers, param: queryParamHash, success: { (successResponseDict) in
//                
//                print(successResponseDict)
//                let alertController = UIAlertController(title:"" , message:successResponseDict.valueForKey("message") as? String , preferredStyle: .Alert)
