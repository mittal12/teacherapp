...
class SSASideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    @IBInspectable var contentViewInLandscapeOffsetCenterX: Float = 100.0
    @IBInspectable var contentViewInPortraitOffsetCenterX: Float = 100.0
    ...
    let contentViewContainer: UIView = UIView()
    ...
    fileprivate func animateMenuViewControllerCompletion(_ side: SSASideMenuSide, menuViewController: UIViewController) {
        ...
        visible = true
        contentViewContainer.alpha = 0.3
    ...
    fileprivate func hideMenuViewController(_ animated: Bool) {
        ...
        let isRightMenuVisible: Bool = false
        ...
        statusBarNeedsAppearanceUpdate()
        contentViewContainer.alpha = 1.0
